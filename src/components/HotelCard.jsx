...
const HotelCard = ({room, index}) => {
  return (
    <Link to={'/room/' + room._id} key={room._id} onClick={() => scrollTo(0,0)}>
        <img src={room.images[0]} alt="roomImage" className='relative max-w-70 w-full 
        ...
        <div className='p-4 pt-5'>
            <div className='flex items-center justify-between' >
               {index % 2 == 0 && <p className='font-playfair text-xl
                font-medium text-gray-800'>{room.hotel.name}</p>
                }
