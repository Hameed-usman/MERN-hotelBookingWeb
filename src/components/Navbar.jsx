...
Dashboard        + Owner            
                ...
                <div className="hidden md:flex items-center gap-4">
                  <img src={assets.searchIcon} alt="searchIcon" className={`${isScrolled && 'invert'} h-7 transition-all duration-300`} />
                        ...
                        (
                            <UserButton>
                                <UserButton.MenuItems>
                                    <UserButton.Action label="My Booking" onClick={() => navigate('/my-bookings')} labelIcon={<BookIcon />} /> 
                ...
                <div className="flex items-center gap-3 md:hidden">
                {
                    user &&   <UserButton>
                    <UserButton.MenuItems>
                        <UserButton.Action label="My Booking" onClick={() => Navigate('/my-bookins')} labelIcon={<BookIcon />} /> 
